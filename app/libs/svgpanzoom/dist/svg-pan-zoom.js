...
, _createZoomIn: function(instance) {
    var zoomIn = document.createElementNS(SvgUtils.svgNS, 'div');
    ...
    var zoomInBackground = document.createElementNS(SvgUtils.svgNS, 'span'); // TODO change these background space fillers to rounded rectangles so they look prettier
    ...
    var zoomInShape = document.createElementNS(SvgUtils.svgNS, 'span');
